...
public class SC011_Payment_ManualSettlement_OrderId_BirthdayOffer extends BaseClass {
	ExcelUtility x = new ExcelUtility("SC006");
	String courseName;

	@Test(enabled = true, priority = 0)
	public void SC011_Payment_ManualSettlement_OrderId_BirthdayOffer() throws Exception {
