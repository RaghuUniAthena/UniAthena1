...
public class SC013_Payment_ManualSettlement_OrderId_UARewards extends BaseClass {
	ExcelUtility x = new ExcelUtility("SC006");
	String courseName;

	@Test(enabled = true, priority = 0)
	public void SC013_Payment_ManualSettlement_OrderId_UARewards() throws Exception {
